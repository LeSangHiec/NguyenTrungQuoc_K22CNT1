...
import NtqSinhVienAddOrEdit from './components/NtqSinhVienAddOrEdit';
function NtqApp() {
  ...
  const ntqGetAllUsers = async  ()=>{
    const ntqResponse = await axios.get("SinhVien");
  ...
  const [SinhVien, setSinhVien] = useState(ntqInitUser);
  ...
  let ntqElementForm = ntqAddOrEdit===true?
      <NtqSinhVienAddOrEdit renderUsers={SinhVien} 
  ...
  return (
    <div className="container border my-3">
        ...
        <hr/>
        <NtqListUsers   renderNtqListUsers={ntqListUsers} 
