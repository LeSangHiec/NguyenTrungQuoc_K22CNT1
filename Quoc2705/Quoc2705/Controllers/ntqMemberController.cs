...
namespace Quoc2705.Controllers
{
    public class ntqMemberController : Controller
    {
        // GET: ntqMember
        ...
        {
            //chuyển dữ liệu nhận được tới View Details return View("Details",m); 
        }
        ...
        public ActionResult CreateTwo(Member m)
        {
            ...
            //nếu không xảy ra lỗi thì chuyển dữ liệu tới View Details return View("Details", m); 
        }
